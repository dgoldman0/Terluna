# Historical synthetic-training log

Archived from the repository README at `79a60a1a51b4552ac9ae8e8bb295b567d9254995`. Relative dataset links have been adjusted for this location and trailing whitespace normalized; the log text is otherwise preserved. The work is deprecated and supplies no empirical evidence.
...
Training data: [terluna_conversations_150_fixed_with_system](foundation/terluna_conversations_150_fixed_with_system.jsonl)
...
Training data: [longer_responses.jsonl](foundation/longer_responses.jsonl)
...
Training data: [correction_samples.jsonl](foundation/correction_mode/correction_samples.jsonl)
...
Training data: [rough_draft.jsonl](history/rough_draft.jsonl) (previous version)
