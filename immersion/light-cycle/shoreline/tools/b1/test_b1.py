...
def main():
    ...
    benchmark=json.loads((b.ROOT/'data/a3/generated/benchmark.json').read_text())
    data=json.loads((b.ROOT/'data/a1/spectral-inputs.json').read_text());dw=np.full(48,10.);dw[[0,-1]]=5.;W=683*np.array(data['cie1931_xyz'])*dw[:,None]
    group_errors=[]
