/* Browser-side numerical checks. Called by the actual Three.js test harness. */
() => {
 ...
 for(const uv of [[.50,.43],[.50,.45],[.50,.48],[.62,.43]]){
  ...
  depth.push({uv,deviceDepth:pixels[0],opaqueViewZ_m:pixels[1],flatWaterViewZ_m:waterZ,geometricDepth_m:OpenMoonCore.waterDepth(hit.x,hit.z),estimatedOpticalPath_m:Math.max(0,(pixels[1]-waterZ)*t/waterZ)});
 }
