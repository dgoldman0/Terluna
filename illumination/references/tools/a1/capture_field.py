...
def main():
    ...
    html=(VIEWER/ENTRY).read_bytes();server,base=serve_viewer()
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            page.on('request',lambda r:report['external_requests'].append(r.url) if not r.url.startswith(('blob:','data:',base)) else None)
